...
- What is the Mary Gates Symposium?
    ...
    **Participant abstracts are published in the Symposium Proceedings, and students can include their presentations on resumes and graduate school applications.**
    ...
    Once accepted into your symposium, it’s recommended to checkout workshops such as the abstract writing and poster design to better prepare yourself.
    
    Abstract writing: www.washington.edu/undergradresearch/workshops/abstracts/ Poster design: www.washington.edu/undergradresearch/workshops/posters/
    
    For more info on the symposium: [www.washington.edu/undergradresearch/symposium/](http://www.washington.edu/undergradresearch/symposium/)
    
- How can people apply?
    
    An application process is required to submit. Deadline is usually in February. It is recommended to get a head start early on November.  Here are the guidelines of the application: [www.washington.edu/undergradresearch/symposium/application-info/](http://www.washington.edu/undergradresearch/symposium/application-info/)
